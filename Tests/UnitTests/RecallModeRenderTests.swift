    ...
    @MainActor final class RecallModeRenderTests: XCTestCase {
        ...
        func testRecallModePromptWithReadingAndEnglish() throws {
            ...
            UserDefaults.standard.set(true, forKey: "showRomaji")
            ...
            try renderAndSaveScreenshot(promptPane, filename: "T044-recall-prompt-with-english.png")
        }

        func testRecallModePromptWithoutRomaji() throws {
            let container = try makeContainer()
            let context = ModelContext(container)
            let fixedTime = makeDate(year: 2026, month: 7, day: 17, hour: 12, minute: 0)
            let clock = AppClock.fixed(fixedTime, timeZone: tokyo)
            ...
            UserDefaults.standard.set(false, forKey: "showRomaji")
            ...
            try renderAndSaveScreenshot(promptPane, filename: "T044-recall-prompt-no-romaji.png")
        }

        func testRecallModePromptNoEnglish() throws {
            let container = try makeContainer()
            let context = ModelContext(container)
            let fixedTime = makeDate(year: 2026, month: 7, day: 17, hour: 12, minute: 0)
            let clock = AppClock.fixed(fixedTime, timeZone: tokyo)
            ...
            try renderAndSaveScreenshot(promptPane, filename: "T044-recall-prompt-kana-no-english.png")
        }

        func testRecallModeAnswerAfterReveal() throws {
            let container = try makeContainer()
            let context = ModelContext(container)
            let fixedTime = makeDate(year: 2026, month: 7, day: 17, hour: 12, minute: 0)
            let clock = AppClock.fixed(fixedTime, timeZone: tokyo)
            ...
            try renderAndSaveScreenshot(promptPane, filename: "T044-recall-answer.png")
        }
